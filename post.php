...
<body>
  ...
  <form method="post" action="post.php" enctype="multipart/form-data">
	...
	<div class="input-group">
		...
		<textarea id="descriere" name="descriere" placeholder="Scrie aici descrierea postării..." maxlength="10001" value="<?php echo $descriere; ?>"></textarea>
  	</div>
	<div class="input-group">
